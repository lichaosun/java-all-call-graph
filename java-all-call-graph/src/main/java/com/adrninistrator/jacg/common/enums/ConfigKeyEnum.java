...
public enum ConfigKeyEnum implements MainConfigInterface {
    ...
    CKE_CALL_GRAPH_OUTPUT_EXT("call.graph.output.ext", "生成调用链文件的格式，.txt: txt文件，.svg: svg文件", String.class),
    CKE_CALL_GRAPH_JAVA_DIR("call.graph.java.dir", "java源码地址，（默认为空）", String.class),
